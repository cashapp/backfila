...
class DynamoDbLastEvaluatedKeyTest {
  ...
  class PausingBackfill @Inject constructor(
    ...
    override fun fixedSegmentCount(config: PrepareBackfillConfig<Parameters>): Int? = config.parameters.segmentCount

    override fun partitionCount(config: PrepareBackfillConfig<Parameters>): Int = config.parameters.partitionCount
  }
}
