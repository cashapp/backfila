...
abstract class Backfill {
  abstract val parameterData: BackfillParameters
...
fun main() {
  ...
  val backfill = LunchBackfill(builder.operator.mapToDataClass(fromBackfila)) // we have parameterDataClass, how do we cast the data class to the actual class so we don't need that secondary constructor?
